...
pub use feature::{
    ...
    AlignmentDiagnosticTap, AlignmentResult, BackendDevice, FeatureExtractor, FeatureFrame,
    FeatureMatch, FeatureMatcher, FeatureTriplet, FramePair, KeyPoint, KeypointScore,
    MatchDirection, NoOpAlignmentDiagnosticTap, PairwiseMatchSet, PointDetector, RotationMatrix3x3,
    SuperPointConfig, SuperPointDescriptorMatcher, SuperPointDetector, SuperPointExtractor,
    TranslationVector3, TripletConsistencyConfig, DEFAULT_SUPERPOINT_MODEL_SHA256,
    DEFAULT_SUPERPOINT_MODEL_URL, FALLBACK_SUPERPOINT_MODEL_URL, MODEL_CANVAS_HEIGHT,
    MODEL_CANVAS_WIDTH, POINT_DETECTION_MAX_LONGEST_EDGE,
};
pub use geom::{
